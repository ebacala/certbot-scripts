...
export NGINX_EMAIL_ADDRESS=$ginx_email_address
...
envsubst '${NGINX_DOMAIN_NAME} ${NGINX_SUB_DOMAIN_NAME} ${NGINX_REPOSITORY}' < templates/certbot_sub_domain_static.template > /etc/nginx/sites-available/${NGINX_DOMAIN_NAME}
