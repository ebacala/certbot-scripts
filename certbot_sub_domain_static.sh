...
envsubst '${NGINX_DOMAIN_NAME} ${NGINX_SUB_DOMAIN_NAME} ${NGINX_REPERTORY}' < templates/certbot_sub_domain_static.template > /etc/nginx/sites-available/${NGINX_DOMAIN_NAME}
